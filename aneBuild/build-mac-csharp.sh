...
PROJECT_PATH="../CSharpLibrary/WebSocketClientNativeLibrary/WebSocketClientNativeLibrary.csproj"
OUTPUT_DIR="../CSharpLibrary/WebSocketClientNativeLibrary/bin/Release/net9.0"
...
ARM64_LIB="$ARM64_DIR/WebSocketClientNativeLibrary.dylib"
X64_LIB="$X64_DIR/WebSocketClientNativeLibrary.dylib"
MACOS_UNIVERSAL_LIB="$MACOS_UNIVERSAL_DIR/WebSocketClientNativeLibrary.dylib"
...
install_name_tool -id "@loader_path/Frameworks/WebSocketClientNativeLibrary.dylib" "$MACOS_UNIVERSAL_LIB"
if [ $? -ne 0 ]; then
...
IOS_ARM64_LIB="$IOS_ARM64_DIR/WebSocketClientNativeLibrary.dylib"
IOS_UNIVERSAL_LIB="$IOS_UNIVERSAL_DIR/WebSocketClientNativeLibrary.dylib"
...
install_name_tool -id "@executable_path/Frameworks/WebSocketANE_IOS_Wrapper.framework/Frameworks/WebSocketClientNativeLibrary.dylib" "$IOS_UNIVERSAL_LIB"
if [ $? -ne 0 ]; then
